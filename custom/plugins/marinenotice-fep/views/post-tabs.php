...
<div id="fep-posts">
  <div id="fep-message"></div>
	...
	<div id="fep-post-table-container">
		...
		<?php else: ?>
			<p>You have <b class="count"><?=$author_posts->found_posts?></b> <?=(($status=='publish')?'live':$status)?> notice(s).</p>
		<?php endif; ?>
		<table>
			<?php
		...
		<div class="fep-nav">
			<?php if($new_exist): ?>
				<a class="fep-nav-link fep-nav-link-left" href="?fep_type=<?=$status?>&fep_page=<?=($paged-1)?>">&#10094; Newer Notices</a>
			<?php endif; ?>
			<?php if($old_exist): ?>
				<a class="fep-nav-link fep-nav-link-right" href="?fep_type=<?=$status?>&fep_page=<?=($paged+1)?>">Older Notices &#10095;</a>
			<?php endif; ?>
