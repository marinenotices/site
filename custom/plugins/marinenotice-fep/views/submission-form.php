...
<div id="fep-new-post">
	...
	<form id="fep-submission-form">
        ...
        <?php endif; ?>
            ...
            <tr><th>Latitude</th><td><label for='dm-degrees-lat'>Deg</label> <input type='text' id='dm-degrees-lat' size='4' maxlength="4" /></td><td colspan='2'><label for='dm-minutes-lat'>Min (decimal)</label> <input type='text' id='dm-minutes-lat' /></td></tr>
            <tr><th>Longitude</th><td><label for='dm-degrees-long'>Deg</label> <input type='text' id='dm-degrees-long' size='4' maxlength="4" /></td><td colspan='2'><label for='dm-minutes-long'>Min (decimal)</label> <input type='text' id='dm-minutes-long' /></td></tr>

            <tr><th colspan='4'>Degrees, Minutes and Seconds</th></tr>
            <tr><th>Latitude</th><td><label for='dms-degrees-lat'>Deg</label> <input type='text' id='dms-degrees-lat' size='4' maxlength="4" /></td><td><label for='dms-minutes-lat'>Min</label> <input type='text' id='dms-minutes-lat' size='2' maxlength="2" /></td><td><label for='dms-seconds-lat'>Sec</label> <input type='text' id='dms-seconds-lat' size='2' maxlength='2'/></td></tr>
            <tr><th>Longitude</th><td><label for='dms-degrees-long'>Deg</label> <input type='text' id='dms-degrees-long' size='4' maxlength="4" /></td><td><label for='dms-minutes-long'>Min</label> <input type='text' id='dms-minutes-long' size='2'maxlength="2" /></td><td><label for='dms-seconds-long'>Sec</label> <input type='text' id='dms-seconds-long' size='2' maxlength='2' /></td></tr>
        </table>
