...
?>
	...
	<article <?php post_class(); ?>>
		...
		<header>
			<h1><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><img class="marker alignnone" src="<?php echo MarineNotice::getNoticeIconURL(MarineNotice::getNoticeTypeFromPost($post)) ?>"><?php the_title(); ?></a></h1>
			<?php woo_post_meta(); ?>
		</header>
